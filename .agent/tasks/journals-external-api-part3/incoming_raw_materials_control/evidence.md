# incoming_raw_materials_control — external POST verification — 2026-04-15T17:35:01.809Z
...
## Response (verbatim)
```json
{"ok":true,"documentId":"cmnyp95d6005108tssm00ul2t","entriesWritten":1,"createdDocument":false,"templateCode":"incoming_raw_materials_control"}
```
