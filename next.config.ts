  ...
  async headers() {
    ...
    return [
      ...
      },
      {
        ...
        source:
          "/((?!_next/static|_next/image|api/journal-samples|api/journal-previews|journal-samples/|brand/|icons/|uploads/|favicon\\.ico|manifest\\.json|sw\\.js|robots\\.txt|sitemap\\.xml|screenshots/|b/[a-z0-9]+/badge\\.svg|og(?![a-z0-9-])|blog/feed\\.xml|whats-new/feed\\.xml).*)",
        headers: [
          {
            key: "Cache-Control",
            value:
