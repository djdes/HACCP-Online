...
**Текущий приоритет:** **P3.A7 — acceptance-document-client v2** (P3.A6 — у perishable-rejection нет отдельной settings-модалки, wave-1 N/A; редактируется через add-row dialog который — в wave-2)
