...
- [/] **C10**: Видео — нет исходников, **отложено** (нужна съёмка реального заполнения журнала на кухне)
...
- **C10** (видео): нет видеоматериалов — нужна съёмка повара на кухне с планшетом 30-60 сек
...
- C5: BLOG/FAQ swap так что финальный flow PRICING → SECURITY → ROI → HOW → AUDIENCE → PARTNERSHIP → MOBILE → CASES → FAQ → BLOG → CTA (9ac56943)
