...
const DESCRIPTION = "Сколько стоит отсутствие журналов и нарушения санитарных правил: статьи 6.3, 6.6, 14.43 КоАП с суммами для ИП, юрлиц и должностных лиц. Отметьте нарушения — увидите диапазон.";
