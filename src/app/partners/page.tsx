...
const DESC =
  "Партнёрская программа WeSetup для консультантов по СанПиН и ХАССП и интеграторов: клиенты в одном кабинете под вашим брендом и вознаграждение с подписок.";
