          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[20px] font-semibold text-[#0b1024]">
                {unfilledCount === 0
                  ? "Все обязательные журналы на сегодня заполнены"
                  : `Нужно заполнить сегодня: ${unfilledCount}`}
              </h2>
              <p className="mt-0.5 text-[13px] text-[#6f7282]">
                {unfilledCount === 0
                  ? "Отличная работа. Можно переключиться на текущие задачи."
                  : "Нажмите на карточку, чтобы открыть журнал и внести запись."}
              </p>
            </div>
          </div>
