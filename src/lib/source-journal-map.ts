...
export const SOURCE_JOURNAL_MAP: SourceJournalMapItem[] = [
  ...
  { sourceSlug: "auditprotocol", localCode: "audit_protocol_scan", status: "mapped" },
  { sourceSlug: "auditreport", localCode: "audit_report_scan", status: "mapped" },
  { sourceSlug: "traceabilityjournal", localCode: "traceability_test", status: "mapped" },
  { sourceSlug: "metalimpurityjournal", localCode: "audit_plan_scan", status: "candidate" },
