...
export const SOURCE_JOURNAL_MAP: SourceJournalMapItem[] = [
  ...
  { sourceSlug: "sanitation1journal", localCode: "cleaning_ventilation_checklist", status: "mapped" },
  ...
  { sourceSlug: "brakery1journal", localCode: "perishable_rejection", status: "mapped" },
  { sourceSlug: "acceptance1journal", localCode: "incoming_control", status: "mapped" },
  { sourceSlug: "acceptance2journal", localCode: "incoming_raw_materials_control", status: "mapped" },
  { sourceSlug: "deepfatjournal", localCode: "fryer_oil", status: "mapped" },
  { sourceSlug: "medbook", localCode: "med_books", status: "mapped" },
  { sourceSlug: "eduplan", localCode: "training_plan", status: "mapped" },
  { sourceSlug: "edujournal", localCode: "staff_training", status: "mapped" },
  ...
  { sourceSlug: "audit_protocol_scan", localCode: "audit_protocol", status: "mapped" },
  { sourceSlug: "audit_report_scan", localCode: "audit_report", status: "mapped" },
  { sourceSlug: "metal_impurity_scan", localCode: "metal_impurity", status: "mapped" },
