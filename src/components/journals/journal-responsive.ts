...
export const JOURNAL_DOCUMENT_SHELL_CLASS =
  "rounded-[24px] border border-[#eceef5] bg-white px-4 py-5 shadow-[0_1px_3px_rgba(15,23,42,0.04)] sm:rounded-[28px] sm:px-6 sm:py-6 lg:rounded-[32px] lg:px-8 lg:py-7";
...
export const REGISTER_DOCUMENT_PAGE_CLASS =
  "mx-auto max-w-[1860px] px-4 py-5 sm:px-6 sm:py-6 lg:px-8";
...
export const REGISTER_DOCUMENT_SUMMARY_CLASS =
  "mb-8 rounded-[20px] bg-[#f3f4fe] px-4 py-4 sm:mb-10 sm:rounded-[24px] sm:px-6 sm:py-5";
