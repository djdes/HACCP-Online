 ...
 * контентной колонки (1296px), высота 48px, БЕЗ скругления, фон #f3f4fe,
 ...
 *
 * Геометрия ленты — та же, что у DOC_FILTER_STRIP_CLASS: `-mx-4 md:-mx-6`
...
export const DOC_AUTOFILL_STRIP_CLASS =
  "-mx-4 mb-10 flex min-h-[48px] items-center gap-3 bg-[#f3f4fe] px-4 py-3 print:hidden md:-mx-6 md:px-6";
