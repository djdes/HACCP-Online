    ...
    <div className="space-y-6 text-black">
      ...
      <div className="space-y-5 rounded-[20px] border bg-white p-6">
        ...
        {!readOnly && <div className="flex flex-wrap gap-3">
          ...
          <Button type="button" className="h-14 rounded-2xl bg-[#5b66ff] px-6 text-[18px] hover:bg-[#4d58f5]" onClick={() => setAddModalOpen(true)}><Plus className="size-5" />Добавить изделие</Button>
