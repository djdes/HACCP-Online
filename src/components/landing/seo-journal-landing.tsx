...
export const SEO_LANDINGS: Record<string, SeoJournalConfig> = {
  ...
  "zhurnal-zdorovya": {
    ...
    metaDescription:
      "Электронный журнал здоровья сотрудников по СанПиН 2.3/2.4.3590-20. Допуск к смене, отметки об отстранении, контроль медкнижек. Бесплатно до 3 сотрудников.",
    intro:
  ...
  "elektronnyy-zhurnal-sanpin": {
    ...
    metaDescription:
      "Все журналы СанПиН 2.3/2.4.3590-20 онлайн: гигиена, температура, бракераж, уборка. Автозаполнение, PDF для проверок. Бесплатно до 3 сотрудников.",
    intro:
