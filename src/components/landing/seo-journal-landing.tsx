...
export const SEO_LANDINGS: Record<string, SeoJournalConfig> = {
  "zhurnal-haccp": {
    ...
    metaDescription:
      "Электронный журнал ХАССП для кафе, ресторанов и производств. Бракераж, термообработка, контроль CCP, прослеживаемость. Бесплатно до 5 сотрудников.",
    intro:
  ...
  "elektronnyy-zhurnal-sanpin": {
    ...
    metaDescription:
      "Все журналы СанПиН 2.3/2.4.3590-20 онлайн: гигиена, температура, бракераж, уборка. Автозаполнение, PDF для проверок. Бесплатно до 5 сотрудников.",
    intro:
  ...
  "zhurnal-uborki": {
    ...
    metaDescription:
      "Журнал уборки помещений по СанПиН: скачать образец или вести онлайн. График, ответственные, отметки о выполнении. Бесплатно до 5 сотрудников.",
    intro:
  ...
  "temperaturnyy-list-holodilnika": {
    ...
    metaDescription:
      "Температурный лист холодильного оборудования по СанПиН. Замеры утром и вечером, напоминания в Telegram, PDF для проверки. Бесплатно до 5 сотрудников.",
    intro:
  ...
  "haccp-dlya-kafe": {
    ...
    metaDescription:
      "ХАССП для кафе и ресторанов: блок-схемы, контрольные точки, обязательные журналы. Внедрение за 1 день, бесплатный тариф до 5 сотрудников.",
    intro:
