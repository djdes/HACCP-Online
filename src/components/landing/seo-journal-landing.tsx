...
export const SEO_LANDINGS: Record<string, SeoJournalConfig> = {
  "zhurnal-haccp": {
    ...
    metaTitle:
      "Журнал ХАССП скачать — электронный шаблон для общепита",
    metaDescription:
  ...
  "zhurnal-zdorovya": {
    ...
    metaTitle:
      "Журнал здоровья сотрудников общепит — электронный",
    metaDescription:
  ...
  "elektronnyy-zhurnal-sanpin": {
    ...
    metaTitle:
      "Электронный журнал СанПиН — все 35 журналов в одном кабинете",
    metaDescription:
  ...
  "brakerazhnyy-zhurnal": {
    ...
    metaTitle:
      "Бракеражный журнал образец — электронная форма для кафе",
    metaDescription:
  ...
  "zhurnal-uborki": {
    ...
    metaTitle:
      "Журнал уборки помещений скачать — электронная форма",
    metaDescription:
  ...
  "temperaturnyy-list-holodilnika": {
    ...
    metaTitle:
      "Температурный лист холодильника — электронный журнал",
    metaDescription:
