...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        MENU_ITEM_CLASS,
        "data-[inset]:pl-9 data-[variant=destructive]:text-[#a13a32] data-[variant=destructive]:focus:bg-[#fff4f2] data-[variant=destructive]:focus:text-[#a13a32] data-[variant=destructive]:*:[svg]:text-[#a13a32]!",
        className
      )}
      {...props}
    />
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute left-3 flex size-4 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <CircleIcon className={cn("size-2 fill-current", MENU_INDICATOR_CLASS)} />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[11px] tracking-widest text-[#9b9fb3]",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronRightIcon className="ml-auto size-4 text-[#9b9fb3]" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
